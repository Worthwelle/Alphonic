...
abstract class BaseTestCase extends PHPUnitTestCase {
    public $structure = array(
        'alphabets' => array(
            'nato.json'             => '{"code": "TESTALPHA","title": {"en": "NATO Phonetic Alphabet"},"default_locale": "en","description": "A test alphabet.","source": "http://www.worthwelle.com","alphabets": {"en": {"A": "Alfa","N": "November","T": "Tango","O": "Oscar"}}}',
